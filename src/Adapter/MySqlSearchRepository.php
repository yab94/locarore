...
use Rore\Adapter\MysqlDatabase;
...
class MySqlSearchRepository implements SearchRepositoryInterface
{
    ...
    private function hydratePack(array $row): Pack
    {
        return new Pack(
            ...
            name:              $row['name'],
            slug:              $row['slug'],
            description:       $row['description'],            descriptionShort:   $row['description_short'] ?? null,            pricePerDay:       (float) $row['price_per_day'],
