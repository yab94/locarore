...
use Rore\UseCase\GetProductWithDetailsUseCase;
use Rore\UseCase\GetReservedQuantityForProductUseCase;
...
class ProductController extends SiteController
{
    ...
    private function findCategoryBySlugOrId(?string $slug, int $fallbackId, array $allCategories): ?\Rore\Entity\Category
    {
        if ($slug) {
            foreach ($allCategories as $cat) {
                if ($cat->getSlug() === $slug) {
