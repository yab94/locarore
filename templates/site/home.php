...
<section class="bg-brand-600 text-white py-16 rounded-2xl mb-10 text-center">
    <h1 class="text-4xl font-bold mb-3"><?= \Rore\Infrastructure\Cms\SettingsStore::html('hero.title') ?></h1>
    <p class="text-lg opacity-90 mb-6"><?= \Rore\Infrastructure\Cms\SettingsStore::html('hero.subtitle') ?></p>
    <a href="#categories" class="bg-white text-brand-700 font-semibold px-6 py-3 rounded-lg hover:bg-gray-100 transition">
        <?= \Rore\Infrastructure\Cms\SettingsStore::html('hero.cta') ?>
    </a>
</section>

<?php $homeIntro = \Rore\Infrastructure\Cms\SettingsStore::get('home.intro'); ?>
<?php if ($homeIntro): ?>
...
<section id="categories" class="mb-12">
    <h2 class="text-2xl font-bold text-gray-800 mb-6"><?= \Rore\Infrastructure\Cms\SettingsStore::html('home.categories_title') ?></h2>
...
<section>
    <h2 class="text-2xl font-bold text-gray-800 mb-6"><?= \Rore\Infrastructure\Cms\SettingsStore::html('home.featured_title') ?></h2>
