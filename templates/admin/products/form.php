...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2">
        <form id="product-form" method="post"
              action="<?= $product ? $urlResolver->resolve(\Rore\Presentation\Controller\Admin\ProductController::class . '.update', ['id' => $product->getId()]) : $urlResolver->resolve(\Rore\Presentation\Controller\Admin\ProductController::class . '.store') ?>"
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <form method="post" action="<?= $urlResolver->resolve(\Rore\Presentation\Controller\Admin\ProductController::class . '.uploadPhoto', ['id' => $product->getId()]) ?>"
