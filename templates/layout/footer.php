<footer class="bg-white border-t mt-auto">
    <div class="container mx-auto px-4 max-w-6xl py-6 text-sm text-gray-500 text-center space-y-1">
        ...
        <div>
            <a href="<?= $urlResolver->resolve(\Rore\Presentation\Controller\Site\LegalController::class . '.mentions') ?>" class="hover:text-gray-700 hover:underline">Mentions légales</a>
        </div>
    </div>
</footer>
