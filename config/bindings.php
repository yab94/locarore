...
$container->register(RRB\Session\SessionInterface::class, RRB\Session\PhpSession::class);
$container->register(Rore\Application\Auth\Port\AdminLoginRateLimiterInterface::class, Rore\Infrastructure\Security\LoginRateLimiterAdapter::class);
$container->register(Rore\Application\Cart\Port\CartServiceInterface::class, Rore\Application\Cart\Service\CartService::class);
$container->register(Rore\Application\Catalog\Port\PackRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlPackRepositoryAdapter::class);
$container->register(Rore\Application\Catalog\Port\ProductRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlProductRepositoryAdapter::class);
$container->register(Rore\Application\Reservation\Port\AvailabilityServiceInterface::class, Rore\Application\Reservation\Service\AvailabilityService::class);
$container->register(Rore\Domain\Catalog\Service\PricingServiceInterface::class, Rore\Domain\Catalog\Service\PricingService::class);
$container->register(Rore\Application\Catalog\Port\CategoryRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlCategoryRepositoryAdapter::class);
$container->register(Rore\Application\Catalog\Port\SlugUniquenessServiceInterface::class, Rore\Application\Catalog\Service\SlugUniquenessService::class);
$container->register(Rore\Application\Catalog\Port\TagRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlTagRepositoryAdapter::class);
$container->register(Rore\Application\Catalog\Port\FileManagerInterface::class, Rore\Infrastructure\File\FileManagerAdapter::class);
$container->register(Rore\Application\Reservation\Port\ReservationRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlReservationRepositoryAdapter::class);
$container->register(Rore\Application\Catalog\Port\FileUploaderInterface::class, Rore\Infrastructure\File\FileUploaderAdapter::class);
$container->register(Rore\Application\Catalog\Port\ImageManagerInterface::class, Rore\Infrastructure\File\ImageManagerAdapter::class);
$container->register(Rore\Application\Contact\Port\ContactMessageRepositoryInterface::class, Rore\Infrastructure\Persistence\MySqlContactMessageRepositoryAdapter::class);
