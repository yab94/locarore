...
- **Template Helpers** : utilitaires de présentation (HtmlEncoder)
...
2. ✅ **Services de présentation** (UrlResolver, PageMetaBuilder, HtmlEncoder)
...
| Presentation | SEO/Template      | `Resolver`, `Builder`, `Helper` | `UrlResolver`, `PageMetaBuilder`, `HtmlEncoder` |
